package ch.jalu.injector.extras.handlers.testimplementations;
...
public class ProfilePostConstructHandler implements PostConstructHandler {
    ...
    public <T> T process(final T object) throws ReflectiveOperationException {
        ...
        Class<?>[] constructorTypes = getConstructorType(clazz, getInstantiation(clazz));
     ...
     * @param instantiation the associated instantiation method
     * @return the constructor arguments
     */
    private static Class<?>[] getConstructorType(Class<?> clazz, Instantiation<?> instantiation) {
        if (instantiation instanceof FieldInjection<?> || instantiation instanceof InstantiationFallback<?>) {
            return new Class<?>[0];
        } else if (instantiation instanceof ConstructorInjection<?>) {
            return getConstructorType((ConstructorInjection<?>) instantiation);
        }
