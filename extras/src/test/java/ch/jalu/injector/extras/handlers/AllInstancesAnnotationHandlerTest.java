...
import ch.jalu.injector.extras.samples.ProvidedClass;
...
public class AllInstancesAnnotationHandlerTest {
    ...
    public void shouldInstantiateSubTypesWithDeclaredType() {
        ...
        // then
        assertThat(correctFields.basicServices, hasSize(2));
        assertThat(correctFields.basicServices, not(hasItem(nullValue(BasicService.class))));
        assertThat(correctFields.animals, hasSize(7));
        assertThat(correctFields.animals, not(hasItem(nullValue(Animal.class))));
        assertThat(correctFields.roarServices, empty());
    }
    ...
    private static final class CorrectFields {
        @Inject
        @AllInstances
        private Collection<BasicService> basicServices;
        ...
        @Inject
        @AllInstances
        private List<RoarService> roarServices;
    }
